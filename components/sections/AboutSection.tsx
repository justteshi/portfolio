  ...
  return (
    <section id="about" className="section-shell section-rule scroll-mt-20">
      <Container>
        ...
        <div className="mt-16 grid gap-10 md:grid-cols-[0.75fr_1fr] md:gap-16" data-motion-group>
          <div className="relative aspect-[4/5] overflow-hidden rounded-[var(--radius-lg)] bg-panel" data-motion-item>
          ...
          <div className="flex flex-col justify-between gap-10" data-motion-item>
