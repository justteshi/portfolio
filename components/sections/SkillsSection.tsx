  ...
  return (
    <section id="skills" className="section-shell section-rule scroll-mt-20">
      <Container>
        ...
        <div className="mt-16 grid border-t border-l border-line sm:grid-cols-2 lg:grid-cols-4" data-motion-group>
          {skills.map((skill, index) => (
            <article key={skill.name} className="interactive-lift flex min-h-40 items-end justify-between border-r border-b border-line p-5 hover:bg-panel" data-motion-item>
